...
export const announcementsData = [
  { id: 1, title: 'About 4A Math Test', class: '4A', date: '2026-02-25' },
  { id: 2, title: 'About 3A Math Test', class: '3A', date: '2026-02-25' },
  { id: 3, title: 'About 3B Math Test', class: '3B', date: '2026-02-25' },
  { id: 4, title: 'About 6A Math Test', class: '6A', date: '2026-02-25' },
  { id: 5, title: 'About 8C Math Test', class: '8C', date: '2026-02-25' },
  { id: 6, title: 'About 2A Math Test', class: '2A', date: '2026-02-25' },
  { id: 7, title: 'About 4C Math Test', class: '4C', date: '2026-02-25' },
  { id: 8, title: 'About 4B Math Test', class: '4B', date: '2026-02-25' },
  { id: 9, title: 'About 3C Math Test', class: '3C', date: '2026-02-25' },
  { id: 10, title: 'About 1C Math Test', class: '1C', date: '2026-02-25' },
];
...
export const calendarEvents = [
  ...
  },
  {
    ...
    end: new Date(2026, 1, 25, 13, 45),
  },
  {
    title: 'History',
    allDay: false,
    start: new Date(2026, 1, 25, 14, 0),
    end: new Date(2026, 1, 25, 14, 45),
  },
  ...
  },
  {
    ...
    end: new Date(2026, 1, 27, 13, 45),
  },
  {
    title: 'History',
    allDay: false,
    start: new Date(2026, 1, 27, 14, 0),
    end: new Date(2026, 1, 27, 14, 45),
  },
  ...
  // 28 Feb 2026
  {
    ...
    end: new Date(2026, 1, 28, 9, 45),
  },
  {
    title: 'Biology',
    allDay: false,
    start: new Date(2026, 1, 28, 10, 0),
    end: new Date(2026, 1, 28, 10, 45),
  },
  {
    title: 'Physics',
    allDay: false,
    start: new Date(2026, 1, 28, 11, 0),
    end: new Date(2026, 1, 28, 11, 45),
  },
  {
    title: 'History',
    allDay: false,
  ...
  // 01 Mar 2026 (since Feb 29 doesn't exist)
  {
    title: 'Math',
    allDay: false,
    start: new Date(2026, 2, 1, 8, 0),
    end: new Date(2026, 2, 1, 8, 45),
  },
  {
    title: 'English',
    allDay: false,
    start: new Date(2026, 2, 1, 9, 0),
    end: new Date(2026, 2, 1, 9, 45),
  },
  {
    title: 'Physics',
    allDay: false,
  ...
  },
  {
    title: 'Chemistry',
    allDay: false,
    start: new Date(2026, 2, 1, 13, 0),
    end: new Date(2026, 2, 1, 13, 45),
  },
  {
    title: 'History',
    allDay: false,
    start: new Date(2026, 2, 1, 14, 0),
    end: new Date(2026, 2, 1, 14, 45),
  },
];
